...
mts <- rbind(mtsu, mtsp)
colnames(m) <- c('input', 'func', 'trial', 'rca', 'rcar', 'rce', 'rcer', 'paired')

# Adapted from: https://rpubs.com/sjackman/grid_arrange_shared_legend
# Thanks to Shaun Jackman
...
grid_arrange_shared_legend2(tn_u, tn_p)
dev.off()
```
...
fi_u_100 <- feature_importances_plot_various_genomes('bt2', 'u', 100)
fi_c_100 <- feature_importances_plot_various_genomes('bt2', 'c', 100)
fi_d_100 <- feature_importances_plot_various_genomes('bt2', 'd', 100)
fi_b_100 <- feature_importances_plot_various_genomes('bt2', 'b', 100)

pdf(file="feat_import_bt2_100.pdf", onefile=F)
grid_arrange_shared_legend(fi_u, fi_c, fi_d, fi_b)
dev.off()

fi_u_250 <- feature_importances_plot_various_genomes('bt2', 'u', 250)
fi_c_250 <- feature_importances_plot_various_genomes('bt2', 'c', 250)
fi_d_250 <- feature_importances_plot_various_genomes('bt2', 'd', 250)
fi_b_250 <- feature_importances_plot_various_genomes('bt2', 'b', 250)

pdf(file="feat_import_bt2_250.pdf", onefile=F)
grid_arrange_shared_legend(fi_u_250, fi_c_250, fi_d_250, fi_b_250)
dev.off()
...
#fi_b_bwa_100 <- feature_importances_plot_various_genomes('bwamem', 'b', 100)

pdf(file="feat_import_bwa_100.pdf", onefile=F)
grid_arrange_shared_legend(fi_u_bwa_100, fi_c_bwa_100, fi_d_bwa_100)
dev.off()
...
#fi_b_bwa_250 <- feature_importances_plot_various_genomes('bwamem', 'b', 250)

pdf(file="feat_import_bwa_250.pdf", onefile=F)
grid_arrange_shared_legend(fi_u_bwa_250, fi_c_bwa_250, fi_d_bwa_250)
dev.off()
