...
cp tmp.eps ~/git/ts-paper/preprint/figures/various_length.eps
...
cp tmp.eps ~/git/ts-paper/preprint/figures/various_length_local.eps
...
cp tmp.eps ~/git/ts-paper/preprint/figures/various_sensitivities_${SIZE}_${LOCAL_STR}.eps
...
cp tmp.eps ~/git/ts-paper/preprint/figures/various_genomes_${SIZE}.eps
done
...
cp tmp.eps ~/git/ts-paper/preprint/figures/various_simulators_${SIZE}.eps
done
...
cp tmp.eps ~/git/ts-paper/preprint/figures/various_aligners.eps
